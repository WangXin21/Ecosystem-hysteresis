...
if __name__ == '__main__':
    ...
    RMSE_low, R_squared_low = trans(data_BSA_low_recovery, data_BSA_low_enrichment, shape='Z', data_TPP_x=[0.70, 1.1], k=k_low)
    RMSE_intermediate, R_squared_intermediate = trans(data_BSA_intermediate_recovery, data_BSA_intermediate_enrichment, shape='Z', data_TPP_x=[2.5, 5], k=k_intermediate)
    RMSE_high, R_squared_high = trans(data_BSA_high_recovery, data_BSA_high_enrichment, shape='Z', data_TPP_x=[5, 10], k=k_high)
